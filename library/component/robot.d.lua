...
---@return boolean, nil|string
function use(side, sneaky, duration)
end
...
---@param amount? number
---@return boolean
function transferTo(toSlot, amount)
end
...
---@param count? number
---@return boolean
function transferFluidTo(tank, count)
end
